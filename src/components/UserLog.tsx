...
import { removeUser } from "../rdx/userDataSlice";
...
export const UserLog:React.FC = () => {
    ...
    return (
        <div className="flex flex-col-reverse md:flex-row gap-y-4 md:gap-x-6 items-center">
            {isAuth && (
                <div className="flex flex-row gap-3 items-center border rounded-full px-2 py-1 md:px-4 md:py-2">
                    {avatar ? (
                        <img 
                            src={avatar} 
                            alt="userAvatar" 
                    ...
                    <p className="text-white text-[9px] md:text-sm uppercase">
                        {email}
                    </p>
                </div>
            )}
